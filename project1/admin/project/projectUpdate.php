								 ...
								 <?php
								  ...
								  <input type="hidden" class="form-control" name="project_id" value="<?php echo $project['id']; ?>">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" id="sub_title" name="sub_title" value="<?php echo $project['sub_title']; ?>" >
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<textarea rows="5" cols="5" class="form-control" placeholder="Default textarea" for="details" name="details"><?php echo $project['details']; ?></textarea>
										</div>
									</div>
