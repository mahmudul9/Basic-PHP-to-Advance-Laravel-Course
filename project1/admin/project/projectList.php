					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							...
							<div class="heading-elements">
								...
								<li style="margin-right: 10px; color: #fff; border-radius:10px;"><a href="projectAdd.php" class="btn btn-primary add-new">Add New</a></li>
			...
			<!-- ####### Data from database to website table ########## -->
						...
						?>
								<tr>
									...
									<td>
										<img class="img-responsive" width="100%" height="100%" src="<?php echo "../uploads/projectImage/".$project["project_thumb"];?>" />    
									</td> 

									<td class="text-center">

									<a href="projectUpdate.php?project_id=<?php echo $project['id']; ?>"><i class="icon-pencil5"></i></a>
									<a href="projectDelate.php?project_id=<?php echo $project['id']; ?>"><i class=" icon-trash"></i></a>
